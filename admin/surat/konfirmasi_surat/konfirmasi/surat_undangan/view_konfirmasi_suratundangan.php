<?php 
  ...
  $id = $_GET['id'];
  $qCek = mysqli_query($connect,"SELECT tb_guru.*, surat_undangan.*, FROM tb_guru LEFT JOIN surat_undangan ON surat_undangan.nip = tb_guru.nip WHERE surat_undangan.id_undangan='$id'");
            ...
            <div class="col-md-12">
                <div class="box box-default">
                    <div class="box-header with-border">
                        <h2 class="box-title"><i class="fas fa-envelope"></i> Konfirmasi Surat Undangan</h2>
                    ...
                    <div class="box-body">
                        <form class="form-horizontal" method="post" action="konfirmasi_surat_undangan.php">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="box-body">
                          ...
                          ?>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">Nama Pengajuan</label>
                                            <div class="col-sm-9">
                                ...
                                <div class="col-md-6">
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="fkegiatan" style="text-transform: capitalize;"
                                                    value="<?php echo $row['kegiatan']; ?>" class="form-control"
                                                    readonly>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">Tanggal Acara</label>
                                            <div class="col-sm-9">
                                                <input type="text" name="ftanggal_acara"
                                                    style="text-transform: capitalize;"
                                                    value="<?php echo $row['tanggal_acara']; ?>" class="form-control"
                                                    readonly>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">Lokasi Acara</label>
                                            <div class="col-sm-9">
                                                <input type="text" name="ftempat_acara"
                                                    style="text-transform: capitalize;"
                                                    value="<?php echo $row['tempat_acara']; ?>" class="form-control"
                                                    readonly>
                                            </div>
                                        </div>
                                    </div>
