...
<div class="content-wrapper">
    <section class="content-header">
      ...
      if(isset($_GET['filter']) && ! empty($_GET['filter'])){
        $filter = $_GET['filter'];
        if($filter == '1'){
          echo '<h1>Laporan Surat Administrasi Sekolah - Surat Keluar</h1>';
        }else if($filter == '2'){
          ...
          echo '<h1>Laporan Surat Administrasi Sekolah - Surat Keluar (Tanggal '.$tgl . $blnIndo[$bln] . $thn.')</b>';
        }else if($filter == '3'){
          $nama_bulan = array('', 'Januari','Februari','Maret','April','Mei','Juni','Juli','Agustus','September','Oktober','November','Desember');
          echo '<h1>Laporan Surat Administrasi Sekolah - Surat Keluar (Bulan '.$nama_bulan[$_GET['bulan']].' '.$_GET['tahun'].')</b>';
        }else if($filter == '4'){
          echo '<h1>Laporan Surat Administrasi Sekolah - Surat Keluar (Tahun '.$_GET['tahun'].')</b>';
        }
      }else{
        echo '<h1>Laporan Surat Administrasi Sekolah - Surat Keluar</h1>';
      } 
        ...
        <div class="row">
          ...
          ?>
                ...
                <div class="col-md-3" align="right">
                    ...
                    <a href="../laporan/laporan.php" name="filter" class="btn btn-danger btn-md"><i
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group" id="form-tahun">
                                        ...
                                        <select class="form-control" name="tahun">
                                            <option value="">Pilih</option>
                                            <?php
                        $query = "SELECT YEAR(created_date_surat) AS tahun FROM tb_surat GROUP BY YEAR(created_date_surat)";
        ...
        ?>
            ...
            ?>
                    ...
                    ?>
                            ...
                            <td><?php echo $data['keperluan_surat']; ?></td>
                        </tr>
                        <?php
                }
              }else{
