        ...
        <navbar class="navbar navbar-expand-lg navbar-dark bg-info">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                <ul class="navbar-nav ml-auto mt-lg-3 mr-5 position-relative text-right">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#">TENTANG <b>SIPERLAH</b></a>
                    </li>
                    <!-- 
        ...
        <div class="container shadow p-3 mb-5 mt-lg-5 bg-white rounded">
            <div style="max-height:cover; padding-top:30px; padding-bottom:60px; position:relative; min-height: 100%;">
                <div class="card-body">
                    <div class="card-text">
                        <p>
                            <label style="font-weight: 700;font-size: 25px"><i class="fas fa-info-circle"></i> APA ITU
                                SIPERLAH?</label>
                            <hr>
                        <blockquote>
                        ...
                        <br>
                        <p class="card-text">
                            <label style="font-weight: 700;font-size: 25px"><i class="fas fa-shield-alt"></i> HAK CIPTA
                                DAN KETENTUAN</label>
                        </p>
                        <hr>
                        <b>©</b>SIPERLAH</b> 2023.
                    ...
                    <div class="row text-center">
                        <div class="col-md-12">
                            ...
                            <p class="text-muted">Trademark By <b><a href="#" style="text-decoration:none">FIF</a></b>
                            </p>
                        </div>
